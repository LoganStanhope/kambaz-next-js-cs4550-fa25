    ...
    return (
        <div id={"wd-lab1"}>
            ...
            <div id="wd-lists">
                ...
                My favorite recipe - Apple Crisp:
                <ol id="wd-your-favorite-recipe">
                    <li>Preheat oven to 350 degrees F.</li>
                    <li>Cream 1 cup white sugar with 1 stick softened butter.</li>
                    <li>Add in 1 cup of rolled oats and 1/2 cup flour.</li>
                    <li>Toss diced and skinned apples with cinnamon and brown sugar.</li>
                    <li>Place apples in a greased baking dish.</li>
                    <li>Sprinkle the oat topping on the apples.</li>
                    <li>Bake for 30-40 minutes or until topping is golden brown.</li>
                    <li>Serve with some vanilla ice cream and whipped cream!</li>
                </ol>
            </div>
            {/* --------------------------------------------------------*/}
            {/* -------------------- UNORDERED TAGS ---------------------*/}
            ...
            And
            <a href="https://github.com/LoganStanhope/kambaz-next-js-cs4550-fa25" id="wd-github"> click here </a>
            to view my code repository on GitHub<br/>
