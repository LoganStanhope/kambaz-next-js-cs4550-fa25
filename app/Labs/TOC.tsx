...
export default function TOC() {
    ...
    return (
        <Nav variant="pills" className="d-flex flex-row justify-content-center">
            ...
            <Nav.Item>
                <Nav.Link as={Link} href="/Labs/Lab4" id="wd-a4" active={pathname.includes("Labs/Lab4")}> Lab
                    4 </Nav.Link>
            </Nav.Item>

            <Nav.Item>
                <Nav.Link as={Link} href="/Labs/Lab5" id="wd-a5" active={pathname.includes("Labs/Lab5")}> Lab
                    5 </Nav.Link>
            </Nav.Item>
            ...
            <Nav.Item>
                <Nav.Link href="https://github.com/LoganStanhope/kambaz-node-server-app" target="_blank" rel="noopener noreferrer">
                    My Server GitHub
                </Nav.Link>
            </Nav.Item>
            <Nav.Item>
                <Nav.Link href="https://kambaz-node-server-app-lwup.onrender.com/" target="_blank" rel="noopener noreferrer">
                    Running Server
                </Nav.Link>
            </Nav.Item>
        </Nav>
